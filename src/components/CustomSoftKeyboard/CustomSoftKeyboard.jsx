    ...
    return (
      <View className='CustomSoftKeyboard'>
        <View className='keyboard-header'>
          <Input type='text' value={notes} onInput={(e) => this.onChange('notes', e)} class='keyboard-note' placeholder='备注' />
        ...
        <View className='keyboard-content'>
          ...
          >
            <View 
              className='keyboard-content-button'
              onClick={()=>this.keyboardClick(item)}
            >
